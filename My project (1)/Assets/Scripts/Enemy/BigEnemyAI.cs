...
{
    private static class BigEnemyAnimations
    {
        public static readonly string IDLE = "BigEnemyIdle";
        public static readonly string WALK = "BigEnemyWalk";
        public static readonly string START_ATK = "BigEnemyAttack";
        public static readonly string RESOLVE_ATK = "BigEnemyResolveAttack";
    ...
    private BigAttackCaster caster;
    ...
    void Start()
    {
        ...
        caster = GetComponent<BigAttackCaster>();
        currentAnimation = BigEnemyAnimations.IDLE;
    }
    ...
    private bool CheckResolveAttack()
    {
        ...
        {
            isAttacking = false;
            currentAnimation = BigEnemyAnimations.RESOLVE_ATK;
    ...
    {
        currentAnimation = BigEnemyAnimations.START_ATK;
    ...
    private void MoveToTarget(Vector2 targetPosition)
    {
        ...
        currentAnimation = BigEnemyAnimations.WALK;
